...
class xajaxEventPlugin extends xajaxRequestPlugin
{
	...
	*/
	function xajaxEventPlugin()
	{
		...
		if (isset($_GET['xjxevt'])) $this->sRequestedEvent = mysql_real_escape_string($_GET['xjxevt']);
		if (isset($_POST['xjxevt'])) $this->sRequestedEvent = mysql_real_escape_string($_POST['xjxevt']);
	}
