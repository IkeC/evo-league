...
class xajaxFunctionPlugin extends xajaxRequestPlugin
{
	...
	*/
	function xajaxFunctionPlugin()
	{
		...
		if (isset($_GET['xjxfun'])) $this->sRequestedFunction = mysql_real_escape_string($_GET['xjxfun']);
		if (isset($_POST['xjxfun'])) $this->sRequestedFunction = mysql_real_escape_string($_POST['xjxfun']);
	}
