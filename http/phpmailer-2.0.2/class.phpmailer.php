...
class PHPMailer {
  ...
  function Send() {
	...
	// echo "<p>Mailer is ".$this->Mailer."</p>";
    /* Choose the mailer */
    switch($this->Mailer) {
      case 'sendmail':
  ...
  function MailSend($header, $body) {
	...
	if (stristr($header, "BASE64")) { 
		die('body does not contain the expected element. Full halt. Body: '.$header);
	}else	if (stristr($body, "BASE64")) { 
		die('body does not contain the expected element. Full halt. Body: '.$body);
	}
	 else {
